// You can use await without async while using type: "module" in the script on html file .
...
function handleFilterClick(e) {
  let target = e.target;
  //   SPAN PROBLEM FIXED HERE.
  if (e.target.classList.contains("only-small-screen")) {
    target = e.target.closest("a");
  }
  //   SPAN PROBLEM FIXED HERE.
  e.preventDefault();
  // MAIN WORK FOR FILTER PAGE ACOORDING TO CLICK BUTTON
  filterButton.forEach((el) => {
...
// Another function to filter by data-filter attribute in htmlFile
